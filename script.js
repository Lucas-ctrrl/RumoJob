const professions = [
  {
    ...
    howToBecome:
      "Formação técnica em Automação Industrial ou cursos técnicos similares.",
    skills: [
  ...
  },
  {
    ...
    howToBecome:
      "Curso técnico ou superior em áreas relacionadas à automação ou eletrônica.",
    skills: [
      "Programação de CLPs",
  ...
  },
  {
    ...
    description:
      "Analisa e implementa tecnologias para melhorar os processos industriais.",
    howToBecome:
      "Graduação em Engenharia ou áreas afins, com especialização em tecnologia industrial.",
    skills: [
      "Análise de dados",
      "Conhecimento em sistemas MES e ERP",
      "Planejamento estratégico",
    ],
    progression:
      "Analista Sênior → Coordenador de Tecnologia → Gerente de Inovação.",
  },
  {
    ...
    description:
      "Orienta empresas na escolha e implementação de soluções automatizadas.",
    howToBecome:
      "Graduação em Engenharia de Automação, com experiência em projetos industriais.",
  ...
  },
  {
    ...
    howToBecome:
      "Formação técnica ou superior em Automação ou Engenharia Elétrica.",
    skills: [
  ...
  },
  {
    ...
    howToBecome:
      "Pós-graduação ou experiência avançada em automação industrial.",
    skills: [
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Ciência da Computação ou áreas afins com experiência avançada em desenvolvimento de software.",
    skills: [
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Sistemas de Informação, Ciência da Computação ou áreas relacionadas.",
    skills: [
      "SQL",
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Segurança da Informação, Sistemas de Informação ou áreas correlatas.",
    skills: [
      "Análise forense",
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Tecnologia da Informação, Engenharia ou Administração com experiência em gestão de projetos.",
    skills: [
      "Gestão de projetos",
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Redes de Computadores, Sistemas de Informação ou áreas afins.",
    skills: [
  ...
  },
  {
    ...
    howToBecome:
      "Graduação em Ciência da Computação, Análise de Sistemas ou áreas afins.",
    skills: [
  ...
  if (window.location.pathname.endsWith("resultado.html")) {
    ...
    if (profession) {
      ...
      detailsContainer.innerHTML = `
                ...
                <p><strong>Como se tornar:</strong> ${
                  profession.howToBecome
                }</p>
                <p><strong>Habilidades Necessárias:</strong> ${profession.skills.join(
                  ", "
                )}</p>
                <p><strong>Progressão da Carreira:</strong> ${
